...
namespace WeiboHotSearch
{
    public static class HttpClientExtensions
    {
        ...
        {
            var content = await httpClient.GetReadAsStringAsync(uri, queryData, headers);
        ...
        public static async Task<string> GetStringAsync(
            ...
            HttpKeyValue? headers = default)
        {
            return await httpClient.GetReadAsStringAsync(uri, queryData, headers);
        }
        ...
        public static async Task<T?> PostAsync<T>(
            ...
            HttpKeyValue? headers = default)
        {
            var content = await httpClient.PostReadAsStringAsync(uri, queryData, formData, headers);
            return JsonSerializer.Deserialize<T>(content, Options);
        }
        ...
        public static Task<string> PostAsStringAsync(
            ...
            HttpKeyValue? headers = default)
        {
            return httpClient.PostReadAsStringAsync(uri, queryData, formData, headers);
        }
